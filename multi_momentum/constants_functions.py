...
def Neff(y_arr, P_arr, f0): # P_arr is just P for each y
    # for P = [2, 0, 0, 0] should give 1
    # for P = [1, ?, ?, ?] should give 0
    integrand = f0 * np.power(y_arr, 3) * (P_arr[0::4] - 1)
